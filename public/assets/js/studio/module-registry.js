export const STUDIO_MODULE_VERSION = 'module-registry-v2';
...
export const STUDIO_MODULES = Object.freeze([
  ...
  { id: 'studio', name: 'Evara Studio', status: 'rebuild', progress: 30, permissions: ['owner', 'admin'], dependencies: ['permissions', 'design-system', 'components', 'graph-core', 'operation-engine'], routes: ['/website-builder.html'] },
  { id: 'components', name: 'Component Engine', status: 'active', progress: 38, permissions: ['owner', 'admin'], dependencies: ['design-system', 'graph-core'], routes: [] },
