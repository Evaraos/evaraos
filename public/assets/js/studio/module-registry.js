...
export const STUDIO_MODULES = Object.freeze([
  ...
  { id: 'canvas-engine', name: 'Canvas Engine', status: 'release-candidate', progress: 94, permissions: ['owner', 'admin'], dependencies: ['design-system', 'graph-core', 'operation-engine'], runtimeDependencies: ['journal-engine'], routes: ['/website-builder.html'], classification: 'production-ready-source', deploymentState: 'required', validationState: 'pending-external' },
