  ...
  return `
    <div class="sidebar-inner">
      <a class="sidebar-logo-wrap" href="${getAssetPath("index.html")}">
        <img src="${getAssetPath("assets/brand/evaraos-mark.png")}" alt="Evaraos Logo" class="sidebar-logo" />
      </a>
    ...
    <div class="topbar-inner">
      <div class="topbar-left">
        <a class="brand-link" href="/index.html">
          <img src="/assets/brand/evaraos-mark.png" alt="Evaraos Logo" class="brand-logo" />
