(function(){
  ...
  var THEME_CSS="/assets/css/theme.css?v=adaptive-liquid-v6";
  var NAV_CSS="/assets/css/nav.css?v=nav-v25-x-drawer";
  var THEME_JS="/assets/js/theme.js?v=adaptive-liquid-v6";
  ...
  critical.textContent="html{background:#101827 var(--evara-wallpaper-image,linear-gradient(135deg,#101827,#345f9c 48%,#d69ba7)) center/cover fixed no-repeat!important}html.evara-boot-lock body{visibility:hidden!important}html.evara-theme-painted body{visibility:visible!important}body{background:transparent!important}";
  document.head.appendChild(critical);

  function canonicalStylesheet(id,href){
    var link=document.createElement("link");link.id=id;link.rel="stylesheet";link.href=href;link.dataset.evaraAuthority="true";document.head.appendChild(link);return link
  }
  function canonicalModule(id,src){
    var script=document.createElement("script");script.id=id;script.type="module";script.src=src;script.dataset.evaraAuthority="true";document.head.appendChild(script);return script
  }
  ...
  function normalize(node){
    ...
    candidates.forEach(function(item){
      ...
      if(item.tagName==="SCRIPT"){
        ...
        if(src.indexOf("/assets/js/theme.js")>=0||src.indexOf("/assets/js/nav.js")>=0||src.indexOf("theme-boot.js")>=0||src.indexOf("appearance-mode-fix.js")>=0)item.remove();
      }
    })
  }
