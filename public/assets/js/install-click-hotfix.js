(function () {
  ...
  function ensureNoticeStyles() {
    ...
    style.textContent = [
      ...
      ".evara-install-notice-icon{width:42px!important;height:42px!important;border-radius:16px!important;background:rgba(255,255,255,.78) url('/assets/img/icon-512.png?v=brand-logo-1') center/78% 78% no-repeat!important;border:1px solid rgba(255,255,255,.92)!important;box-shadow:0 10px 22px rgba(0,0,0,.13),inset 0 1px 0 rgba(255,255,255,.96)!important;}",
