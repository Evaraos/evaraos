...
function auditPageBootInventory() {
...
if (section === 'all' || section === 'runtime') auditRuntimeContracts();
if (section === 'all' || section === 'pages') auditPageBootInventory();
if (!['all', 'runtime', 'pages'].includes(section)) failures.push(`Unknown audit section: ${section}`);

console.log(`Navigation, customer, and owner publishing audit complete (${section}).`);
